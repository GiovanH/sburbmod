 ...
 * //Note that in 1.10.*, extending BlockContainer can cause rendering problems if you don't extend getRenderType()
 ...
 //  need to implement.
 */
public class BlockCruxtruder extends BlockContainer
{
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand,
		...
		playerIn.openGui(SburbMod.instance, GuiHandlerCruxtruder.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
...
//		}
	...
	{
		TileEntity tileEntity = worldIn.getTileEntity(pos);
		if (tileEntity instanceof TileCruxtruder) {
			TileCruxtruder tileInventoryFurnace = (TileCruxtruder)tileEntity;
			int inventoryFilled = tileInventoryFurnace.inventoryFullness();
...
//		return this.getDefaultState().withProperty(INVENTORY_FILLED, Integer.valueOf(meta));
	}
...
//		return ((Integer)state.getValue(INVENTORY_FILLED)).intValue();
	...
	public static final PropertyInteger INVENTORY_FILLED = PropertyInteger.create("inventory_filled", 0, 4);
  ...
  @Override
	public int getLightValue(IBlockState state, IBlockAccess world, BlockPos pos) {
   	...
   	if (inventoryFilled == 0) {
			...
			lightValue = ONE_SIDE_LIGHT_VALUE + (int)((FOUR_SIDE_LIGHT_VALUE - ONE_SIDE_LIGHT_VALUE) / (4.0 - 1.0) * inventoryFilled);
		}
