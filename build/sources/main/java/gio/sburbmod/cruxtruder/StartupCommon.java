...
public class StartupCommon
{
  ...
  public static ItemBlock itemBlockInventoryAdvanced; // this holds the unique instance of the ItemBlock corresponding to your block
    ...
    //  +--------------------+----------------------+
    //
		blockInventoryAdvanced = new BlockCruxtruder().setUnlocalizedName("sburbmod_cruxtruder");
    blockInventoryAdvanced.setRegistryName("cruxtruder");
    ...
    // Each of your tile entities needs to be registered with a name that is unique to your mod.
		GameRegistry.registerTileEntity(TileCruxtruder.class, "cruxtruder_tile_entity");
		...
		GuiHandlerRegistry.getInstance().registerGuiHandler(new GuiHandlerCruxtruder(), GuiHandlerCruxtruder.getGuiID());
	}
