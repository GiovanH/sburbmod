 ...
 * postInitCommon postInitClientOnly
 */
...
public class StartupClientOnly {
	public static void preInitClientOnly() {
		...
		// Render the texture properly
		ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("sburbmod:alchemiter", "inventory");
