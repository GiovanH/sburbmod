...
public class ContainerAlchemiter extends Container {
	...
	private TileAlchemiter tilePrinter;
	...
	public ContainerAlchemiter(InventoryPlayer invPlayer, TileAlchemiter tilePrinter) {
	...
	public class SlotOutput extends Slot {
		...
		public boolean isItemValid(ItemStack stack) {
			return TileAlchemiter.isItemValidForOutputSlot(stack);
		}
	}
}
