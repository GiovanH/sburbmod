...
public class StartupCommon {
	...
	public static void preInitCommon() {
		...
		blockInventoryAdvanced = new BlockAlchemiter().setUnlocalizedName("sburbmod_alchemiter");
		blockInventoryAdvanced.setRegistryName("alchemiter");
		...
		// to your mod.
		GameRegistry.registerTileEntity(TileAlchemiter.class, "alchemiter_tile_entity");
		...
		// each example's GuiHandler, so that when it gets
		...
		GuiHandlerRegistry.getInstance().registerGuiHandler(new GuiHandlerAlchemiter(),
				GuiHandlerAlchemiter.getGuiID());
	}
