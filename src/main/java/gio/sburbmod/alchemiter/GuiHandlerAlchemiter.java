...
public class GuiHandlerAlchemiter implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tileEntity instanceof TileAlchemiter) {
			TileAlchemiter tileInventoryFurnace = (TileAlchemiter) tileEntity;
			return new ContainerAlchemiter(player.inventory, tileInventoryFurnace);
		}
		return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tileEntity instanceof TileAlchemiter) {
			TileAlchemiter tileInventoryFurnace = (TileAlchemiter) tileEntity;
			return new GuiInventoryAlchemiter(player.inventory, tileInventoryFurnace);
		}
		return null;
	}
