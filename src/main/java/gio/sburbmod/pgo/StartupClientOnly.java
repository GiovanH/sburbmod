...
public class StartupClientOnly {
	public static void preInitClientOnly() {
		...
		ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("sburbmod:generic", "inventory");
		final int DEFAULT_ITEM_SUBTYPE = 0;
		ModelLoader.setCustomModelResourceLocation(StartupCommon.itemBlockSimple, DEFAULT_ITEM_SUBTYPE,
