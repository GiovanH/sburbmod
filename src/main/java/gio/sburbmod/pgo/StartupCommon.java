...
{
  public static BlockGeneric blockSimple;  // this holds the unique instance of your block
  ...
  public static void preInitCommon()
  {
    ...
    //  +--------------------+----------------------+
    //
    blockSimple = (BlockGeneric)(new BlockGeneric().setUnlocalizedName("sburbmod_generic"));
    blockSimple.setRegistryName("generic");
