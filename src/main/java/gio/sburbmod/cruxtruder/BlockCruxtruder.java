...
//			((TileCruxtruder) tileEntity).setPlayerHash(playerIn);
//		}
		...
		playerIn.openGui(SburbMod.instance, GuiHandlerCruxtruder.getGuiID(), worldIn, pos.getX(), pos.getY(),
				pos.getZ());
		return true;
	}
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		TileEntity tileEntity = worldIn.getTileEntity(pos);
		if (tileEntity instanceof TileCruxtruder) {
			TileCruxtruder tileCruxtruder = (TileCruxtruder) tileEntity;
	...
	@Override
	public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase living,
			ItemStack stack) {

		TileCruxtruder tile = (TileCruxtruder) world.getTileEntity(pos);
		if (living instanceof EntityPlayer) {
			tile.setPlayerHash((EntityPlayer) living);
		}
