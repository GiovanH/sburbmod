...
public class GuiInventoryCruxtruder extends GuiContainer {

	// This is the resource location for the background image
	private static final ResourceLocation texture = new ResourceLocation("sburbmod", "textures/gui/cruxtruder_bg.png");
	private TileCruxtruder tileEntity;

	public GuiInventoryCruxtruder(InventoryPlayer invPlayer, TileCruxtruder tileCruxtruder) {
		super(new ContainerCruxtruder(invPlayer, tileCruxtruder));
...
//	final int FLAME_X_SPACING = 18;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int x, int y) {
		...
		drawTexturedModalRect(
				guiLeft + COOK_BAR_XPOS,
				guiTop + COOK_BAR_YPOS + yOffset,
				COOK_BAR_ICON_U,
				COOK_BAR_ICON_V + yOffset,
				COOK_BAR_WIDTH,
...
//		}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		fontRenderer.drawString(tileEntity.playerName + "'s " + tileEntity.getDisplayName().getUnformattedText(),
				LABEL_XPOS, LABEL_YPOS, Color.darkGray.getRGB());
