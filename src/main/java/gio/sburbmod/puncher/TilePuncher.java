 ...
 * TileEntityFurnace.
 */
public class TilePuncher extends TileEntity implements IInventory, ITickable {
	...
	private void extrude(ItemStack input) {
		...
		NBTTagCompound nbtTagCompound = punchedStack.getTagCompound();
	...
	private ItemStack punchingItem;
	...
	public void update() {
		...
		ItemStack fuel = itemStacks[FIRST_FUEL_SLOT];
	...
	public NBTTagCompound writeToNBT(NBTTagCompound parentNBTTagCompound) {
		...
		NBTTagCompound punchingItemTag = new NBTTagCompound();
		if (punchingItem != null)
			punchingItem.writeToNBT(punchingItemTag);

		parentNBTTagCompound.setTag("PunchingItem", punchingItemTag);
	...
	public void readFromNBT(NBTTagCompound nbtTagCompound) {
		...
		punchingItem = new ItemStack(nbtTagCompound.getCompoundTag("PunchingItem"));
	}
	...
	public String getName() {
		return "container.sburbmod_cardpuncher.name";
	}
