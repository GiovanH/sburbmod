...
public class ContainerPuncher extends Container {
	...
	private TilePuncher tilePrinter;
	...
	public ContainerPuncher(InventoryPlayer invPlayer, TilePuncher tilePrinter) {
	...
	public class SlotOutput extends Slot {
		...
		public boolean isItemValid(ItemStack stack) {
			return TilePuncher.isItemValidForOutputSlot(stack);
		}
	}
}
