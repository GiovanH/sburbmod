...
public class GuiInventoryPuncher extends GuiContainer {

	// This is the resource location for the background image
	private static final ResourceLocation texture = new ResourceLocation("sburbmod", "textures/gui/cardpuncher_bg.png");
	private TilePuncher tileEntity;

	public GuiInventoryPuncher(InventoryPlayer invPlayer, TilePuncher tilePuncher) {
		super(new ContainerPuncher(invPlayer, tilePuncher));
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int x, int y) {
		...
		drawTexturedModalRect(guiLeft + COOK_BAR_XPOS, guiTop + COOK_BAR_YPOS, COOK_BAR_ICON_U,
