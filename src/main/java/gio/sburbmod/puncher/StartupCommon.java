...
public class StartupCommon {
	...
	public static void preInitCommon() {
		...
		// +--------------------+----------------------+
		//
		blockPuncher = new BlockPuncher().setUnlocalizedName("sburbmod_cardpuncher");
		blockPuncher.setRegistryName("cardpuncher");
		...
		// to your mod.
		GameRegistry.registerTileEntity(TilePuncher.class, "cardpuncher_tile_entity");
		...
		GuiHandlerRegistry.getInstance().registerGuiHandler(new GuiHandlerPuncher(), GuiHandlerPuncher.getGuiID());
	}
