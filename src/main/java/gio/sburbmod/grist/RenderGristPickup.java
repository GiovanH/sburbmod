...
public class RenderGristPickup extends Render<EntityGristPickup>
{
    private static final ResourceLocation EXPERIENCE_ORB_TEXTURES = new ResourceLocation("textures/entity/experience_orb.png");

    public RenderGristPickup(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityGristPickup entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
       // if (!this.renderOutlines)
        {
        	System.out.println("Rendering a grist");
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityGristPickup entity) {
