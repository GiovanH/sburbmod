...
public class StartupCommon {
	...
	public static void preInitCommon() {
		...
		// +--------------------+----------------------+
		//
		blockPuncher = new BlockLathe().setUnlocalizedName("sburbmod_lathe");
		blockPuncher.setRegistryName("lathe");
		...
		// to your mod.
		GameRegistry.registerTileEntity(TileLathe.class, "lathe_tile_entity");
		...
		GuiHandlerRegistry.getInstance().registerGuiHandler(new GuiHandlerLathe(), GuiHandlerLathe.getGuiID());
	}
