 ...
 * TileEntityFurnace.
 */
public class TileLathe extends TileEntity implements IInventory, ITickable {
	...
	private ItemStack inputUsed;
	private ItemStack fuelUsed;
	...
	public NBTTagCompound writeToNBT(NBTTagCompound parentNBTTagCompound) {
		...
		NBTTagCompound fuelUsedItemTag = new NBTTagCompound();
		if (fuelUsed != null)
			fuelUsed.writeToNBT(fuelUsedItemTag);

		parentNBTTagCompound.setTag("ItemUsed", inputItemItemTag);
		parentNBTTagCompound.setTag("FuelUsed", fuelUsedItemTag);
	...
	public void readFromNBT(NBTTagCompound nbtTagCompound) {
		...
		fuelUsed = new ItemStack(nbtTagCompound.getCompoundTag("FuelUsed"));
	}
	...
	public String getName() {
		return "container.sburbmod_lathe.name";
	}
