...
public class StartupCommon
{
  ...
  public static ItemBlock itemBlockInventoryAdvanced; // this holds the unique instance of the ItemBlock corresponding to your block
    ...
    //  +--------------------+----------------------+
    //
		blockInventoryAdvanced = new BlockPrinter().setUnlocalizedName("sburbmod_cardprinter");
    blockInventoryAdvanced.setRegistryName("cardprinter");
    ...
    // Each of your tile entities needs to be registered with a name that is unique to your mod.
		GameRegistry.registerTileEntity(TilePrinter.class, "cardprinter_tile_entity");
		...
		GuiHandlerRegistry.getInstance().registerGuiHandler(new GuiHandlerPrinter(), GuiHandlerPrinter.getGuiID());
	}
