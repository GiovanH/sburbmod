 ...
 */
public class GuiHandlerPrinter implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tileEntity instanceof TilePrinter) {
			TilePrinter tileInventoryFurnace = (TilePrinter) tileEntity;
			return new ContainerPrinter(player.inventory, tileInventoryFurnace);
		}
		return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tileEntity instanceof TilePrinter) {
			TilePrinter tileInventoryFurnace = (TilePrinter) tileEntity;
			return new GuiInventoryPrinter(player.inventory, tileInventoryFurnace);
		}
		return null;
	}
